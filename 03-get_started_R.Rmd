...
## RStudio System Requirements {#sec-rstudio-system-requirements}

The `ALSroads` package is run using RStudio, the interrogated development (IDE) for R. The minimum system requirements for using RStudio are:
...
Methods for assessing the specifications of a computer depend on the operating system. Guidance on where to find specification information is available online for [Windows](https://www.groovypost.com/howto/find-your-windows-11-pc-hardware-and-system-specs/#:~:text=Find%20Windows%2011%20System%20Specs&text=To%20get%20started%2C%20head%20to,and%20version%20of%20Windows%2011.), [MacOS](https://support.apple.com/en-ca/guide/system-information/syspr35536/mac#:~:text=View%20system%20information%20in%20About,specification%20information%20about%20your%20Mac.), and [Linux](https://medium.com/technology-hits/basic-linux-commands-to-check-hardware-and-system-information-62a4436d40db).

## Installing R and RStudio {#sec-installing-r-and-rstudio}

The open source version of RStudio is available for [download online](https://www.rstudio.com/products/rstudio/download/). The programming language R must be downloaded alongside RStudio, and can be downloaded for [Windows](https://cran.r-project.org/bin/windows/base/), [macOS](https://cran.r-project.org/bin/macosx/), and [Linux](https://cran.r-project.org/).
