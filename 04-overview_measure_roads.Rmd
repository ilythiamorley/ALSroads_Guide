...
#Data
roads <- st_read("E:/data/04/roads.shp")
roads_upd <-st_read("E:/data/04/updated_roads.shp")
road_upd <- st_read("E:/data/04/road_upd.shp")
road_poly <- st_read("E:/data/04/road_poly.shp")
...
The derivable widths of roads, grouped by road class, can be plotted for comparison. Only Class 1 and 2 roads are included as Class 3 and 4 roads do not have updated road widths.
