...
-   CLASS - A 'Class' (1 - 4) is assigned to each road segment. The class is simply computed from the SCORE. Class 4 corresponds to a score [0, 25[, Class 3 to a score [25, 50[ and so on.
