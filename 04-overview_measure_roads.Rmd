...
In this example, we do not include water bodies, refer to section \@ref(sec-waterbodies) for an example application with water bodies. Similarly, here we do not adjust the `ALSroads` default parameters; refer to section \@ref(sec-edge-case-studies) applications of the method with custom parameters.
