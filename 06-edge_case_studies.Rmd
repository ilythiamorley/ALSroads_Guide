...
-   **Low DTM complexity** - an area of uniform elevation
-   **Steep slopes** - an area characterized by steep slopes
-   **No vegetation** - an area where the road is not clearly defined by vegetation, there are three known no vegetation scenarios:
...
1.  Read the required input data, detailed information is available in Section \@ref(sec-reading-generating-and-plotting-input-data).
...
4.  Adjust standard road extraction parameters to improve method accuracy. Information on `measure_roads()` standard parameters is available in Section \@ref(sec-explanation-of-parameters-measure_roads).
...
We adjust the the standard `measure_roads()` parameters, explained in section \@ref(sec-explanation-of-parameters-measure_roads). **The maximum elevation ground points is set to to 0.07 and the maximum standard deviation of ground points to 0.04.**
